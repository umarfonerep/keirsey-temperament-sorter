...
('You are more comfortable making critical judgement than value judgements. '),
('Clutter in the workplace is something you take time to straighten up rather than tolerate pretty well.'),
('It is your way to make your mind up quickly.'),
...
('Interacting with strangers energises you more than it taxes your reserves.'),
('Facts speak for themselves rather than illustrate principles.'),
('You find visionaries and theorists more annoying than facinating.'),
('In a heated discussion, you stick to your guns and don't look for common ground.'),
('It is better to be just than merciful'),
('At work it is more natural to you to point out mistakes than try to please others.'),
('You are more comfortable AFTER a decision than before.'),
('You tend to say right out what's on you mind more than keep your ears open.'),
('Common sense is usually more reliable, than frequently questionable.'),
('Children should make themselves more useful rather than exercising their fantasy.'),
...
('You are more prone to nailing things down than expolring the possibilities. '),
...
('You speak more in particualrs than generalities.'),
...
('In stories you prefer action and adventure to fatancy and heroism.'),
